          ...
          <DataBootstrap>
            <Stack
              screenOptions={{
                ...
                // Global contextual back button: shows the name of the screen
                // you're returning to (e.g. "Today"/"Calendar") instead of
                // "(tabs)". Per-screen headerLeft (e.g. Cancel) overrides this.
