    ...
    >
      ...
      >
        ...
        {isReviewerOnly && taskState === 'approved' && (
          <>
            <Divider />
            <StatusChip icon="✓" text="You approved this task" color="#4ade80" bg="#052e16" />
          </>
        )}
        {isReviewerOnly && taskState === 'rejected' && (
          <>
            <Divider />
            <StatusChip icon="✗" text="You rejected this task" color="#fca5a5" bg="#1a0505" />
            {rejNote !== '' && (
              <View style={[s.rejectionNote, { marginTop: 10 }]}>
                <Text style={s.rejectionNoteLabel}>Your feedback:</Text>
                <Text style={s.rejectionNoteText}>{rejNote}</Text>
              </View>
            )}
          </>
